...
PL: The function in the first part is well-structured, clear, and easy to follow!  
Suggestion to maybe use warning signs, if it doesn't follow the rules of thumb.

geom_text() is a great addition to display the fitted regression equation directly on the plot, which is very useful for interpretation. The use of colors are also visually distinct! 
Something I didn't do, but noticed was the loop function is also a great way for Extracting slope, p-value, and confidence interval for both models

The hypothesis testing section is clearly explained, with the null and alternative hypotheses defined.
It would be useful to mention the p-values explicitly in the interpretation to reinforce why the null hypothesis is rejected for both models.

Overall, everything looks great, just some minor adjustments! 