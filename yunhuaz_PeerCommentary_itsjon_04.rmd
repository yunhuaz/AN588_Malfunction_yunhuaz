...
```
## Jon's Comment: "Looks great. Well organized, and is running smmothly."
...
## Jon's Comment: "Plots look great. The text color didn't get put through, so if you're looking to do that, I think you'll have to re-arrange where you put the text color function."
...
## Jon's Comment: "Thank you for walking through your process. For the most part, everything seems relatively functioning. I like your idea of plot the prediction line onto the existing graph. I went about it by generating the descriptive statistics. Would recommend checking out that comment I made on your m1/m2 scatterplots." 
